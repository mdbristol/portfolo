 ...
 */
	...
	{
	plane= new Passenger[20][6];//creats the 2d array named plane with the size 
 ...
 */
	...
	{
	System.out.println("Please enter the row you wish to seat in:(1-20) ");
	int row = scan.nextInt();//sets the row
	row--;//sets the row to one less so that the user can not worry about the computer language
	System.out.println("Please enter the col you wish to seat in:(1-6) ");
	int col= scan.nextInt();
	scan.nextLine();
	col--;///sets the col by one less
		if(row>19 || col>5 || row<0 || col<0)//tests the bounds of the 2d array 
		{
 ...
 */
	...
	{
		System.out.println("Enter row of seat: (1-20) ");
		int row = scan.nextInt();
		row--;//sets the row by one less
		System.out.println("Enter col of seat:(1-6) ");
		int col = scan.nextInt();
		scan.nextLine();
		col--;//sets the col by one less
		if(row>19 || col>5 || row<0 || col<0)//tests the boundries of the 2d array
		{
 ...
 */
		...
		public void displaySeat()
	{
		...
		if(row>19 || col>5||row<0 || col<0)//checks the boundries of the 2d array
		{
