...
$suffusion_templates_options = array(
		...
		"help" => "Configure how you want to use the templates bundled with Suffusion. Suffusion is packaged with the following templates:
			<ul>
				<li>
					...
					<ul>
						<li><em>Single Category</em> - Assigned whenever you are viewing a category</li>
						<li><em>Single Tag</em> - Assigned whenever you are viewing a tag</li>
						<li><em>Single Author</em> - Assigned whenever you are viewing an author</li>
						<li><em>Search</em> - Assigned whenever you are viewing a search page</li>
						<li><em>Attachments</em> - Assigned whenever you are viewing an attachment</li>
						<li><em>404</em> - Assigned whenever you are viewing a 404 (not found) page</li>
						<li><em>Now Reading</em> - Assigned if you have the \"Now Reading\" or \"Now Reading Reloaded\" plugin</li>
					</ul>
				</li>
				<li>
					Manual Templates<br/>
					...
					<ul>
						<li><em>Magazine</em> - Builds a magazine-styled page</li>
						<li><em>Page of Posts</em> - Shows a list of all your posts</li>
						<li><em>All Categories</em> - Shows all your categories</li>
						<li><em>Sitemap</em> - Creates an HTML sitemap for your site</li>
						<li><em>No Sidebars</em></li>
						<li><em>Single Left Sidebar</em></li>
						<li><em>Single Right Sidebar</em></li>
						<li><em>Single Left, Single Right Sidebar</em></li>
						<li><em>Double Left Sidebars</em></li>
						<li><em>Double Right Sidebars</em></li>
					</ul>
				</li>
			</ul>
			",
	...
	array("name" => "Sidebar layout to adopt",
		"desc" => "Your magazine template can display the default sidebar layout (defined in Sidebar Configuration) or adopt the settings for one of the sidebar-specific templates in this section",
		"id" => "suf_magazine_sidebar_count",
		"parent" => "magazine-template",
		"type" => "radio",
